...
def robust_cca_similarity(acts1, acts2, threshold=0.98, epsilon=0.,
                          compute_coefs=True,
                          compute_dirns=True,
                          verbose=True):
    ...
    for trial in range(num_cca_trials):
        try:
            return_dict = get_cca_similarity(
                acts1, acts2, threshold=threshold, epsilon=epsilon,
                compute_coefs=compute_coefs, compute_dirns=compute_dirns, verbose=verbose)
