...
def robust_pwcaa(acts1, acts2, threshold=0.98, epsilon=1e-6, verbose=False):
    sresults = cca_core.robust_cca_similarity(acts1, acts2,
                                              compute_dirns=True, compute_coefs=True, verbose=verbose)
