...
def extract_reps_sent(
    ...
    for i in range(0, len(data), batch_size):
        ...
        batch_sent_reps = extract_reps_sent_batch(batch, tokenizer_hf, encoder_hf, layer_id)
...
def extract_reps_sent_batch(src, tokenizer_hf, encoder_hf):
    ...
    with torch.no_grad():
        res: BaseModelOutput = encoder_hf.forward(
            **src,
            return_dict=True,
    ...
    hiddens_all_layers = res.hidden_states
